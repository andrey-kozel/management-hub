...
public interface GithubRepository extends Repository<Repo, Long> {
  ...
  @Query("SELECT id FROM github_repository WHERE github_id=:githubId")
  Optional<Long> getIdByGithubId(@Param("githubId") long githubId);
  ...
  @Modifying
  void save(@Param("githubId") long githubId, @Param("nodeId") String nodeId, @Param("name") String name,
  ...
  @Query("UPDATE github_repository " +
  ...
  @Modifying
  void update(@Param("githubId") long githubId, @Param("nodeId") String nodeId, @Param("name") String name, @Param("fullName") String fullName, @Param("aPrivate") boolean aPrivate, @Param("description") String description, @Param("fork") boolean fork, @Param("createdAt") Date createdAt, @Param("updatedAt") Date updatedAt, @Param("pushedAt") Date pushedAt, @Param("homePage") String homePage, @Param("size") long size, @Param("stargazersCount") int stargazersCount, @Param("watchersCount") int watchersCount, @Param("forksCount") int forksCount, @Param("openIssuesCount") int openIssuesCount, @Param("license") String license, @Param("defaultBranch") String defaultBranch, @Param("language") String language, @Param("permissions") String permissions, @Param("archived") boolean archived, @Param("disabled") boolean disabled, @Param("synchronizationEnabled") boolean synchronizationEnabled, @Param("synchronizedAt") Date synchronizedAt, @Param("organizationId") long organizationId);
}
